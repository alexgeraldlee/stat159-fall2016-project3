...
load('stat159/stat159-fall2016-project3/data/ols.RData')
...
<<xtable, results=tex, echo=FALSE>>=
load('stat159/stat159-fall2016-project3/data/plsr.RData')
...
<<xtable, results=tex, echo=FALSE>>=
library(glmnet)
edu = read.csv('stat159/stat159-fall2016-project3/data/final.csv', stringsAsFactors = FALSE)
edu = edu[, -c(1)]
...
load('stat159/stat159-fall2016-project3/data/randomforest.RData')
